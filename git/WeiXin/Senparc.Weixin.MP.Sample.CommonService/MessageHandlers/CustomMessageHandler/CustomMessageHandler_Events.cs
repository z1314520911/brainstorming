    ...
    public partial class CustomMessageHandler
    {
        private string GetWelcomeInfo()
        {
            ...
            return string.Format(
                @"欢迎关注【{0}】{1}",
                ConfigurationManager.AppSettings["WeiXinWebTitle"],
                ConfigurationManager.AppSettings["WeiXinWebWelcome"]);
        }
                ...
                case "wdkf":
                    {
                        //var strongResponseMessage = CreateResponseMessage<ResponseMessageImage>();
                        //reponseMessage = strongResponseMessage;
                        //strongResponseMessage.Image = "您点击了个性化菜单按钮，您的微信性别设置为：女。";
                        var strongResponseMessage = CreateResponseMessage<ResponseMessageText>();
                        reponseMessage = strongResponseMessage;
                        strongResponseMessage.Content = "微信号：acaicaic";
                    }
                    break;
                case "swlx":
                    {
                        var strongResponseMessage = CreateResponseMessage<ResponseMessageText>();
                        reponseMessage = strongResponseMessage;
                        strongResponseMessage.Content = "微信号：16689714808";
                    }
                    break;
                default:
                    {
