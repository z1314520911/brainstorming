...
weixin.menu = {
    ...
    init: function () {
        ...
        $('#menuLogin_Submit').click(function () {
            $.getJSON(Url +'GetToken.aspx?t=' + Math.random(), { appId: $('#menuLogin_AppId').val(), appSecret: $('#menuLogin_AppSecret').val() },
                function (json) {
        ...
        $('#menuLogin_SubmitOldToken').click(function () {
            weixin.menu.setToken($('#menuLogin_OldToken').val());
        });

        $('#btnGetMenu').click(function () {
            menuState.html('获取菜单中...');
            $.getJSON(Url +'GetMenu.aspx?t=' + Math.random(), { token: weixin.menu.token }, function (json) {
                if (json.menu) {
        ...
        $('#btnDeleteMenu').click(function () {
            ...
            $.getJSON(Url +'DeleteMenu.aspx?t=' + Math.random(), { token: weixin.menu.token }, function (json) {
                if (json.Success) {
