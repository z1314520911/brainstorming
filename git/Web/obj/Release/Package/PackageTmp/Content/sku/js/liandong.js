        ...
        Creat_Table: function () {
            ...
            if (bCheck == true) {
                ...
                $.each(arrayTile, function (index, item) {
                    var td = $("<th name=" + item + ">" + item + "</th>");
                    td.appendTo(trHead);
                });
                var itemColumHead = $("<th name='价格' style=\"width:70px;\">价格</th><th name='库存' style=\"width:70px;\">库存</th> ");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        $.each(td_array, function (i, values) {
                            var td = $("<td><input class='noBorder' josnval='' value='" + values + "' /></td>");
                            td.appendTo(tr);
                        });
                        var td1 = $("<td ><input josnval='' name=\"Txt_PriceSon\" class=\"l-text\" type=\"text\" value=\"\"></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input josnval='' name=\"Txt_CountSon\" class=\"l-text\" type=\"text\" value=\"\"></td>");
                        td2.appendTo(tr);
